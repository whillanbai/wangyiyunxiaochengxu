<template>
	<view>
		<view class="search">
			<musicchead title="搜索" :icon="true" :iconblack="true"></musicchead>
			<view class="container">
				<scroll-view scroll-y="true">
					...
					<view class="search-search">
						...
						<text class="iconfont icon-guanbi" v-show="searchType != 1" @tap="handeX"></text>
					</view>
					<block v-if="searchType == 1">
					<view class="search-history">
						<view class="search-history-head">
							<text>历史记录</text>
							<text class="iconfont icon-ashbin" @tap="handleToClear"></text>
						</view>
...
<script>
	import musicchead from '../../components/musicchead/musicchead.vue'
...
<style scoped>
	...
	.search-history{margin: 0rpx 30rpx 50rpx 30rpx;font-size: 26rpx;}
	...
	.search-suggest-item text{color: #bdbdbd;margin-right: 28rpx;}
</style>
