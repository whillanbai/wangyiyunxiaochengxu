<template>
	<view class="detail">
		...
		<musicchead :title="songDetail.name" :icon="true" color="white"></musicchead>
					...
					<view class="detail-like-item" v-for="(item,index) in songSimi" :key="index" @tap="handleToSimi(item.id)">
						...
						<view class="detail-like-song">
							...
							<view>
								...
								<image v-if="item.privilege.maaxbr == 999000" src="../../static/sq.png" mode=""></image>
...
<style scoped>
	...
	.detail-like-song view:nth-child(2) image {
		width: 18px;
		height: 12px;
	}
